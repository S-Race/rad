            ...
            <SnapContainer>
                <SnapSection className="firstSection">
                    <div className="flex flex-col justify-center items-center min-h-screen blue_gloss">
                        ...
                        <h1 className="md:text-5xl text-3xl uppercase font-thin my-3 text-">
                            with <span className="text-blue-700 font-semibold">RAD</span></h1>
                    </div>
                </SnapSection>
                <SnapSection className="flex bg-blue-800 items-center justify-between px-12">
                    <article className="md:w-2/3 w-2/5">
                        ...
                        <div className="md:text-lg text-xl text-gray-200 font-thin">Bringing all of your home music
                            together into one place has never been easier.
